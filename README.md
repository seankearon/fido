...
commands:                 # offered under the Console button, in this order
  - build.ps1
  - aspire start
```
...
drop-down beside the **Console** button, run in a console at the selected location. Fido only ever
*offers* them; nothing runs on its own.
